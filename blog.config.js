...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '浅析', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的计算机专业学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xyx5916.qzz.io/', // 网站地址
